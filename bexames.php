    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                ?>
                <h3 style="text-align: center;">Busca de Exames do Paciente: <strong><?php echo $consulta['nome']; ?></h3>
                <hr>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <!-- <?php echo "<a href='exames.php?id={$consulta['id']}'>+ Exames</a>"; ?> -->
                <!-- <a href="exames.php?id={$consulta['id']}"> -->
                <?php echo "<a href='exames.php?id={$consulta['id']}'>"?>
                <input type="button" class="btn btn-outline-primary" name="btn-CadCondominio" value="+ Exame">
                <?php "</a>;"?>
            </div>
        </div>
        <br>
                        ...
                        while ($linha = $consulta->fetch(PDO::FETCH_ASSOC)) {
                            echo "  <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href='exames.php?id={$linha['id']}'>Exames</a> 
                                    </td>
								</tr>";
                        }
                        ?>
